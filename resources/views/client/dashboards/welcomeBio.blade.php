    ...
    <div class="personal-info">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="width:200px">{{strtoupper(Auth::user()->full_name)}}</td>
            ...
            <tr>
                ...
                <td style="width:200px">{{strtoupper(Auth::user()->qualification->name)}}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width:200px">{{strtoupper (\Carbon\Carbon::parse( Auth::user()->date_last_promotion)->isoFormat('MMMM, DD YYYY'))}}</td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:200px">
                    @if($supervisor)
                        {{strtoupper($supervisor->first_name.' '.$supervisor->last_name)}}
                    @endif
                </td>
            </tr>
